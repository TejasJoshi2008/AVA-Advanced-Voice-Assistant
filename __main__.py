...
good_morning = (
    ...
    "May everything you dreamed about last night comes true!", "Good morning sir . I hope you have a wonderful day.",
    "Life never gives you a second chance. So, enjoy every bit of it. Why not start with this beautiful morning. Good morning sir ",
    ...
    "There is no way you can miss the beauty of today’s morning. I wish this message be your alarm for today.",
    ...
    "Breathing in the fresh morning air makes you healthier and wiser. Don’t ignore the blessings that every morning offers to us.have a good time.",
    "I know you slept tight all night. Now wake up and welcome a new sun so bright, here to make your day right.",
    "you have been blessed with yet another day. What a wonderful way of welcoming the blessing with such a beautiful morning!  ",
    " May you have a day full of sweet wonders ahead!",
    "Sending you good vibes to start your morning with positive energy!",
    "sun has risen wake up to see the most beautiful sunrise ever!!", "May your day goes as bright as the sun is today! ",
    ...
    while True:
        ...
        if answer == "greetings":
            ...
            try:
                ...
                result1 = next(result.results).text
                print(result1)
                say("temperature is")
                say(result1)
            except Exception:
                print("Umm.. I think you are disconnected from the internet")
                print(Exception)
        elif answer == "time":
            now = datetime.now()
